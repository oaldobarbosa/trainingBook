<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo m-2">
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">trainingBook</span>
        </a>
    ...
    {{-- ocultada sombra <div class="menu-inner-shadow"></div> --}}
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Misc -->
        <li class="menu-header small text-uppercase"><span class="menu-header-text">Mais</span></li>
        <li class="menu-item">
